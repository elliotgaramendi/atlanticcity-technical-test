...
export function AppCard({
  ...
  return (
    <Card
      className={cn(
        "rounded-3xl border-sky-200/70 bg-white/85 text-slate-950 shadow-xl shadow-sky-900/5 transition-all duration-300 ease-out dark:border-sky-400/15 dark:bg-slate-950/80 dark:text-sky-50 dark:shadow-sky-950/20",
        tone === "elevated" &&
